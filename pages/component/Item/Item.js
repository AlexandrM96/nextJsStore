        ...
        <div>
            ...
            <div className={styles.item__infoContainer}>
                ...
                <ul>
                    <li>
                        Price:
                        <span className={styles.item__infoContainer__span}>
                                {props.item.data.offers[0].price} ₽
                            </span>
                    </li>
                    <li>
                        Bonuses:
                        <span className={styles.item__infoContainer__span}>
                                {props.item.data.offers[0].bonuses}
                            </span>
                    </li>
                    <li>
                        Code:
                        <span className={styles.item__infoContainer__span}>
                            {props.item.data.offers[0].code}
                        </span>
                    </li>
                    <li>
                        Height:
                        <span className={styles.item__infoContainer__span}>
                                {props.item.data.offers[0].height}
                            </span>
                    </li>
                    <li>
                        Quantity:
                        <span className={styles.item__infoContainer__span}>
                            {props.item.data.offers[0].quantity}
                        </span>
                    </li>
                    <li>
                        Volume:
                        <span className={styles.item__infoContainer__span}>
                                {props.item.data.offers[0].volume}
                            </span>
                    </li>
                    <li>
                        Weight:
                        <span className={styles.item__infoContainer__span}>
                                {props.item.data.offers[0].weight}
                            </span>
                    </li>
                    <li>
                        Width:
                        <span className={styles.item__infoContainer__span}>
                                {props.item.data.offers[0].width}
                            </span>
                    </li>
                    <li>
                        Description:
